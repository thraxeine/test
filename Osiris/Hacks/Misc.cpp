...
void Misc::updateClanTag(bool tagChanged) noexcept
{
    ...
    if (config->misc.customClanTag)
    {
        ...
        if (time != lastTime)
        {
            switch (time % 30)
            {
            case 0: { memory->setClanTag(" manifestations ", " manifestations "); break; }
            case 1: { memory->setClanTag("manifestations ", " manifestations "); break; }
            case 2: { memory->setClanTag(" manifestations ", " manifestations "); break; }
            case 3: { memory->setClanTag(" manifestations ", " manifestations "); break; }
            case 5: { memory->setClanTag(" manifestations ", " manifestations "); break; }
            case 6: { memory->setClanTag(" manifestations ", " manifestations "); break; }
            case 7: { memory->setClanTag(" manifestation ", "manifestation "); break; }
            case 8: { memory->setClanTag(" manifestatio ", " manifestatio "); break; }
            case 9: { memory->setClanTag(" manifestati ", " manifestati "); break; }
            case 10: { memory->setClanTag(" manifestat ", " manifestat "); break; }
            case 11: { memory->setClanTag(" manifesta", " manifesta "); break; }
            case 12: { memory->setClanTag(" manifest ", " manifest "); break; }
            case 13: { memory->setClanTag(" manifes ", " manifes "); break; }
            case 14: { memory->setClanTag(" manife ", " manife "); break; }
            case 15: { memory->setClanTag(" manif ", " manif "); break; }
            case 16: { memory->setClanTag(" mani ", " mani "); break; }
            case 17: { memory->setClanTag(" ma ", " man "); break; }
            case 18: { memory->setClanTag("ma ", " ma "); break; }
            case 19: { memory->setClanTag(" m ", " m "); break; }
            case 20: { memory->setClanTag(" m ", " m "); break; }
...
void Misc::watermark() noexcept
{
    ...
    ImGui::Text("manifestations | %d fps | %d ms", frameRate != 0.0f ? static_cast<int>(1 / frameRate) : 0, GameData::getNetOutgoingLatency());
    ImGui::End();
}
...
void Misc::killMessage(GameEvent& event) noexcept
{
    ...
    case 1:
        ...
        break;
    case 2:
        killMessage = "way too ez for manifestations";
        break;
    case 3:
